...
import com.xd.fivefu.R;
import com.xd.fivefu.bean.CatInfo;
import com.xd.fivefu.utils.AnimatorUtils;
import com.xd.fivefu.utils.MockData;
import com.xd.fivefu.utils.ResUtils;
...
public class CatViewLayout extends FrameLayout {
    ...
    public void mergeCat(int mTouchIndex, int targetIndex) {
        Toast.makeText(getContext(),"合成弹广告",Toast.LENGTH_SHORT).show();
        Log.d("xxxxx","合并===qww===");
        CatInfo[] catList = MockData.getInstance().getCatList();
